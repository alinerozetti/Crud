...
namespace WebCrud.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeFantasia,CNPJ,Cep")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeFantasia,CNPJ,Cep")] Empresa empresa)
        {
            if (id != empresa.Id)
            {
                return NotFound();
