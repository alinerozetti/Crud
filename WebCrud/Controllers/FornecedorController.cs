...
namespace WebCrud.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                fornecedores = fornecedores.
                    Where(s => s.CNPJ_CPF!.Contains(searchString) 
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CNPJ_CPF,Email,Cep,Rg,DtNascimento")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CNPJ_CPF,Email,Cep,Rg,DtNascimento")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
